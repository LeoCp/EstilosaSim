<?php
class EM_Em0121settings_Adminhtml_em0121settings_ThemeController extends Mage_Adminhtml_Controller_Action
{
	protected $_prefixBlock = 'em0121_';
	protected $_prefixPage = 'em0121_';
	protected $_packageTheme = 'default/em0121';
